...
public class ProductsView extends AbstractView {
	...
	protected void createControllerButtons() {
		createButton(addToCartButton, "Agregar", VaadinIcons.CART_O);
		...
		createButton(checkAllButton, "Sel. Todos", VaadinIcons.CHECK_SQUARE_O);

		createButton(uncheckAllButton, "Desel. Todos", VaadinIcons.THIN_SQUARE);
	...
	public void buttonClick(ClickEvent event) {
		...
		if (event.getButton() == getAddToCartButton()) {
			...
			Notification.show("Agregando planes.");
