...
public class CheckoutWindow extends Window {
	...
	//private static final String PROPERTY_PRODUCT_NAME = "plan";
	//private static final String PROPERTY_UNIT_PRICE = "precioUnitario";
	//private static final String PROPERTY_QUANTITY = "cantidad";
	//private static final String PROPERTY_PRODUCT_TOTAL = "totalProducto";
	...
	public CheckoutWindow(ShoppingCart shoppingCart) {
		...
		gridFooter = grid.appendFooterRow();
		gridFooter.join(PROPERTY_PRODUCT_NAME, PROPERTY_UNIT_PRICE,
				PROPERTY_QUANTITY).setText("Total Plan:");
		gridFooter.getCell(PROPERTY_PRODUCT_TOTAL).setText(
				Formatter.formatPrice(shoppingCart.getCartTotal()));

		setCaption("<h2>Gracias por su orden!</h2>");
