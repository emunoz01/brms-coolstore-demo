...
public class ShoppingCartView extends AbstractView {
	...
	protected void createLayout(VerticalLayout layout) {
		...
		layout.addComponent(new ShoppingCartLine("Promocion:",
				cartPromoValue,
				true));
		layout.addComponent(new ShoppingCartLine("Impuesto:", shippingValue));
		layout.addComponent(new ShoppingCartLine("Promocion de compra:",
				shippingPromoValue, true));
		layout.addComponent(new ShoppingCartLine("Total:", cartTotalValue));
	}
	...
	protected void createControllerButtons() {
		...
		createButton(clearButton, "Limpiar", VaadinIcons.CLOSE);
	}
	...
	private void clearShoppingCart() {
		ConfirmDialog dialog = ConfirmDialog.show(UI.getCurrent(),
				"Confirmacion",
				"Esta seguro de limpiar los planes seleccionados en la compra?", "Clear",
